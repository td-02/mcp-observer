...
while IFS= read -r line; do
  ...
  case "$line" in
    ...
    *'"name":"run_query"'*|*'"name": "run_query"'*)
      sleep 0.45
      call_result "$id" '{"rows":"SELECT * FROM demo","latency_ms":503}'
      ;;
